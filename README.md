...
```
dependencies {
    compile(group: 'com.themodernway', name: 'themodernway-common', version: '2.1.0-RELEASE')
}
```
Javadoc URL:
...
http://docs.themodernway.com/documents/reports/themodernway-common-v2/spotbugs/main.html
